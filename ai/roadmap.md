...
| R-008 | Review workflow | in-progress | Formalize review states before tasks are completed. | Implementation and review are distinct before tasks are marked done. | `review` |
